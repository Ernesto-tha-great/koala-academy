        ...
        <ReactMarkdown
          ...
          components={{
            h1: ({ node, children, ...props }) => (
              <h1
                className="text-2xl sm:text-3xl md:text-4xl font-bold mt-6 sm:mt-8 mb-3 sm:mb-4"
                {...props}
              >
                {children}
              </h1>
            ...
            h2: ({ node, children, ...props }) => (
              <h2
                className="text-xl sm:text-2xl md:text-3xl font-bold mt-6 sm:mt-8 mb-3 sm:mb-4"
                {...props}
              >
                {children}
              </h2>
            ...
            h3: ({ node, children, ...props }) => (
              <h3
                className="text-lg sm:text-xl md:text-2xl font-bold mt-5 sm:mt-6 mb-2 sm:mb-3"
                {...props}
              >
                {children}
              </h3>
            ...
            h4: ({ node, children, ...props }) => (
              <h4
                className="text-base sm:text-lg md:text-xl font-bold mt-5 sm:mt-6 mb-2 sm:mb-3"
                {...props}
              >
                {children}
              </h4>
            ...
            h5: ({ node, children, ...props }) => (
              <h5
                className="text-sm sm:text-base md:text-lg font-bold mt-4 mb-2"
                {...props}
              >
                {children}
              </h5>
            ...
            h6: ({ node, children, ...props }) => (
              <h6
                className="text-xs sm:text-sm md:text-base font-bold mt-4 mb-2"
                {...props}
              >
                {children}
              </h6>
            ...
            p: ({ node, children, ...props }) => (
              <p className="my-3 sm:my-4 text-sm sm:text-base" {...props}>
                {children}
              </p>
            ),
            ...
            code({ node, className, children, ...props }) {
              ...
              return match ? (
                ...
                <code
                  className="bg-gray-100 text-red-500 px-1 py-0.5 rounded font-mono text-xs sm:text-sm"
                  {...props}
                >
                  {children}
                </code>
